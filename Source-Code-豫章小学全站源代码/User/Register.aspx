<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Register, App_Web_k5cles0g" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
...
#main{ margin-top:20px; background:none;}
.input_out{ padding-right:0px; padding-top:0px;}
</style>
</head>
        ...
        <div class="reg">
            ...
            <div class="reg_sub">
                ...
                <ul>
                    <li>
                        <div class="reg_put">
                            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="input_out" Height="22">
