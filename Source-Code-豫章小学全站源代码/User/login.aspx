...
<style>
#main_l li{ height:35px; line-height:35px;}
</style>
</head>
<body onload="onfocus();" style="background:url(../Template/yzxx/style/images/Body_bg.jpg) repeat-x;">
<%Call.Label("{ZL.Label id=\"和雅豫章头部\"/}"); %><!--top end-->
<div id="main" style="position:relative; margin-top:20px;">
<form id="form" runat="server">
<div id="main_l" style=" margin-left:200px;">
<ul>
<h1>豫章小学会员中心登录</h1>
...
<li><input type="checkbox" name="checkbox" checked="checked" id="checkbox" style=" margin-right:5px;" />&nbsp;记住登录&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div style="display:none;"><asp:HyperLink ID="hlReg" runat="server"  NavigateUrl="~/User/login.aspx?RegID=1">Email登录</asp:HyperLink> &nbsp;</div><a href="/User/GetPassword.aspx">忘记密码了？ </a></li>
<li>如果您尚未在本站注册为用户，请先点击<a href="Register.aspx">点此注册</a>。</li>
</ul>
</div>
...
<a href="/" style="display:none;"><img src="<%Call.Label("{$LogoUrl/}"); %>" alt="<%Call.Label("{$SiteName/}"); %>" /></a>
<p>
