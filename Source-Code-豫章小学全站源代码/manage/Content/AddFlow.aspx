<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddFlow, App_Web_pkfeggyy" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加审核状态</title>
...
<div class="r_navigation">后台管理&gt;&gt;系统设置&gt;&gt;流程管理 &gt;&gt;<a href="SpecialManage.aspx">添加审核状态</a></div>
<div>
