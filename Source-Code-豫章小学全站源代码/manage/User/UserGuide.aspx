<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserGuide, App_Web_own0w3ym" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
        ...
        <div id="Guide_box">
          ...
          <div class="guide">
            <ul>
              ...
              <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../APP/Suppliers.aspx" target="main_right">APP登录</a></li>
            </ul>
          </div>
        </div>
      </li>
