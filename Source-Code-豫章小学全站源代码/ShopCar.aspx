<%@ page language="C#" autoeventwireup="true" inherits="ShopCar, App_Web_m53mud2n" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>加入购物车</title>
...
<div id="main" class="rg_inout">
    ...
    <div class="jia">
        <ul>
            <li style="width: 250px; text-align: left;">金额合计：<asp:Label ID="alljiage" runat="server" Text=""></asp:Label></li>
